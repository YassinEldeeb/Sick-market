...
const testData = {
  title: 'PlayStation®5',
  body: 'Experience lightning-fast loading with an ultra-high speed SSD, deeper immersion with support for haptic feedback, adaptive triggers and 3D Audio.',
...
const register = asyncHandler(async (req: any, res) => {
