...
const CartProduct: FC<Props> = ({
  ...
  useEffect(() => {
    if (check) {
      setRemoved(check.removed.find((e: any) => e === product._id))
      setSoldOut(check.soldOut.find((e: any) => e === product._id))
    }
  }, [check])
          ...
          <div
            ...
            onClick={() => {
              ...
              if (!product.removed && !product.removed2)
                ...
                setRemovedProducts(
                  removedProducts.filter((e: any) => e !== product._id)
                )
            }}
          >
